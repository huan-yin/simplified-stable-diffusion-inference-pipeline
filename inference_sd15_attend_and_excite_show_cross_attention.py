...
def show_cross_attention(prompt: str,
    ...
    attention_maps = attention_store.aggregate_attention(from_where).detach().cpu()
    images = []
...
with torch.no_grad():
    ...
    visual_image = show_cross_attention(prompt, attention_store, tokenizer, token_indices, from_where=("up", "down", "mid"), orig_image=pil_image)
    save_path = "images/sd15_attend_and_excite_show_attention.png"
